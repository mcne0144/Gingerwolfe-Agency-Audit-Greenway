# COMPETITIVE_MOVE_PLAN.md — Recommended Competitive Content Response (per-store, per-market)

**Status:** INTERNAL — not client-facing. Recommends content moves for Shannon's approval; nothing is posted without the approval pipeline (specialist → team lead → Shannon → client).
**Prepared by:** Bright Matter LLC agency operations team (Audit & Research Analyst)
**Basis:** `competitors/COMPETITOR_RESEARCH.md` (dated 2026-08-22), `content/success-models/CONTENT_MODELS.md` (Models A–E), `content/CONTENT_STRATEGY_FRAMEWORK.md` (pillars/channels), `competitors/COMPETITOR_SETS.md`.
**Evidence labels:** moves are grounded in CONFIRMED (dated 2026-08-22) competitor observations. Where a channel is unobserved, the move is flagged "manual verification needed — 2026-08-22" and marked as a hypothesis to confirm before it drives client-facing content.

**House rules applied to every move:** no fake urgency/hype (FRAMEWORK §4); every vehicle/offer posted must be verifiably real (TO VERIFY — request from client via Shannon McNeil); named staff need two sources (OPERATING_RULES §3.5); no pitching/pricing of services; each store is one market (no group-blur).
...
**Instagram — CLOSED 2026-08-23 (third pass), and it reverses nothing.** Bob Sight carries **1,919 Instagram posts against 672 followers** and a median Reel of ~192 plays; Rob Sight has the better per-post reach (~1,071 on 1,672 followers) but is **stale since 7 May 2026**; Kia on Atlantic is current at 98 followers and ~450 median plays with static posts at 0–3 likes; Kia of Murfreesboro sits at 90 followers and 2 posts; no Wyatt Johnson Instagram was found. **Across all three retrieved competitors every static feed post drew 0–3 likes and every Reel drew 40–1,680 plays** — independent replication of the format rule from accounts unconnected to Greenway. Full log: `COMPETITOR_RESEARCH.md §7.5`. Reddit and Google Business Profile for competitors remain unretrieved.
...
**Two corrections that affect the moves below.** (a) **Kia on Atlantic is at 11750 Abess Blvd, 32225 — east Jacksonville, not the southside.** That framing derives from their former 9401 Atlantic Blvd address. Store 02 at 10564 Philips Hwy, 32256 is genuinely southside, so the two are **not** the same side of town; move 4's proximity argument should be restated as local ownership rather than head-to-head. (b) **CORRECTION 2026-08-23 — an error introduced by the 08-22 reconcile, now withdrawn.** That pass asserted Store 02 has no YouTube account and cited `channel-matrix.csv` for it. The matrix says the opposite: Store 02's YouTube is **Active at `@greenwaykiaattheavenues-b6h`, operator-confirmed 2026-08-22 and explicitly marked CONFLICT RESOLVED**. The false claim came from the 11 Aug channel tracker, which predates the operator's resolution. **Every "YouTube Short" line below is a live slot and needs no stand-up decision.** Store 02's Instagram duplicate (`greenwaykia.jax`) is likewise resolved — operator confirms it inactive.

Recommended content moves (4–5), mapped to channels and content models:

1. **Current per-vehicle inventory line (Model B) — the primary wedge.** No Jacksonville competitor runs one. One short walkthrough per real vehicle on lot (new-arrival + used), VIN/stock-coded, titled for southside/Jacksonville local search ("2024 Kia Sportage Jacksonville, FL", "Kia Telluride near The Avenues"), on YouTube Shorts + IG Reels + TikTok + FB photo.
   - Channels: YouTube Short (1/wk floor), IG Reels, TikTok, FB photo posts.
   - Pillar: Inventory (≥30%). Every vehicle TO VERIFY via real inventory feed before posting.
2. **Kia best-seller depth reviews (Model C).** Telluride, Sportage, Sorento, Carnival, EV9/EV6 — monthly long-form review + weekly review Short, cut for IG/TikTok. No Jacksonville competitor posts current reviews, and this earns the highest per-video views (sibling evidence). Reviews only vehicles verifiably sellable.
   - Channels: YouTube long-form monthly + review Short; IG/TikTok clips. Pillar: Inventory (educational).
3. **Trust + service + proof layer (Model D) — counter the promo-only play.** While Kia on Atlantic pushes offer volume, build "what we check at a service visit," service-bay features, delivery-day/people content, and 100% review & GBP Q&A response. This is the utility + proof Kia on Atlantic's thin promos never cover.
   - Channels: FB (service reminders/features), YouTube long-form explainer (as capacity), IG Stories, GBP service posts + reviews. Pillars: Service (20%) + Reviews & Proof.
4. **People + local southside/Avenues community (Model E) — proximity is the lane.** Both Kia on Atlantic and Store 02 serve the southside; win "the useful dealership on this side of town" with real named staff (two-source rule), delivery-day stories, local/Avenues-area ties, JAX seasonal/local moments (TO VERIFY hooks per market).
   - Channels: FB local hub, IG Stories/Reels, TikTok BTS, YouTube showroom/personality Short. Pillars: Community/Local + Behind-the-Scenes. Named staff TO VERIFY (OPERATING_RULES §3.5).
...
## 3. Store 03 — Greenway Kia Rivergate (Madison, TN) and Store 04 — Greenway Kia Hickory Hollow (Antioch, TN) · GM James Galuszka
...
1. **Consistent people/personality line (Model E / BTS) — each store its own voice.** Murfreesboro's "Kia Guy" proved a recognizable person carries a Nashville-area Kia store; its staleness is our opening. Build a consistent, current people/personality slot (named staff intros, delivery-day stories, "a day at the dealership") for **each rooftop separately** with that rooftop's real people (names TO VERIFY, two-source rule).
   - Channels: TikTok + IG Stories/Reels (personality), YouTube Short, FB BTS.
   - Pillars: Behind-the-Scenes + Community/Local. Do NOT clone "The Kia Guy" persona — each store owns its own.
2. **Service-convenience content (Model D) — the proven local hook.** Murfreesboro's pickup-&-delivery and buy-from-home slots are exactly the local convenience messages that work; adopt and run **current**: "what we check at a service visit," pickup/delivery convenience, recall/maintenance reminders (each store's service facts TO VERIFY).
   - Channels: FB service reminders/features, YouTube long-form explainer (as capacity), IG Stories, GBP service posts + 100% review & Q&A response.
   - Pillars: Service (20%) + Reviews & Proof.
3. **Current per-vehicle inventory line (Model B).** Neither named competitor has a current one; both Nashville rooftops can build a discoverable per-vehicle short list (new-arrival + used lot), VIN/stock-coded, named for the local market (Madison/Goodlettsville for 03; Antioch/La Vergne/Smyrna corridor for 04).
   - Channels: YouTube Short (1/wk floor), IG Reels, TikTok, FB photo. Pillar: Inventory.
4. **Kia best-seller depth reviews (Model C)** — Telluride, Sportage, Sorento, Carnival, EV. These earn the most per-video views (sibling evidence) and no named competitor posts current reviews. Monthly long-form + weekly review Short, cut for IG/TikTok.
   - Channels: YouTube long-form monthly + review Short; IG/TikTok clips. Pillar: Inventory (educational).
5. **Local/community (Model E) — separate per market.** Rivergate (Madison) and Hickory Hollow (Antioch) are distinct communities with different hooks; confirm each and run its own local tie + seasonal/local moments. (Hooks and language split TO VERIFY per market — do not assume.)
   - Channels: FB local hub, IG Stories, TikTok BTS, GBP brief community post. Pillars: Community/Local + BTS.

**Sequencing note (Stores 03/04):** open with move 1 (people/personality) — the proven in-market format, stale among competitors — then moves 2–4 to fill service/inventory, with move 5 per-market after hooks are verified.

---

## 4. Gaps — where the move plan cannot yet act (stated, not guessed)
...
3. **Competitor Facebook, TikTok and Instagram — ALL NOW RETRIEVED (second pass 2026-08-22, third pass 2026-08-23).** Logged in `COMPETITOR_RESEARCH.md` §7 and §7.5. Instagram was the largest remaining gap and is closed; it confirmed the second pass rather than changing it. **What remains unretrieved:** Kia on Atlantic's TikTok (not found in name search, not disproven), Kia of Murfreesboro's Facebook and TikTok, Blue Springs and Metro Ford on all social channels, and Reddit and Google Business Profile for every competitor. No move currently depends on any of these.
...
**Re-check cadence:** re-run this move plan each time a competitor channel becomes retrievable, a new competitor name is supplied or a GM confirms a set, or the blocked platforms are unblocked; re-date every new observation.

---

## 5. Mapping summary

| Move (by store) | Channel emphasis | Pillar | Content model | Evidence status |
|---|---|---|---|---|
| Store 02 · current inventory line | YT Short/IG/Tik/FB | Inventory | Model B | CONFIRMED absence among Jax competitors |
| Store 02 · Kia best-seller reviews | YT long + Short, IG/Tik | Inventory | Model C | CONFIRMED absence among Jax competitors |
